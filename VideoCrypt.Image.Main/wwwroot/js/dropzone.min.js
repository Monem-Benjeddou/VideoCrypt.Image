    ...
    `,                drop: function (e) {
                ...
                addedfile: function (e) {
                    ...
                    function generateFileNameWithExtension(originalName) {
                        ...
                        return generateQuickGuid() + (extension ? '.' + extension : ''); // Append the extension if it exists
                    }
                    ...
                    if (this.previewsContainer && !this.options.disablePreviews) {
                        ...
                        // Apply new file name
                        let newFileName = generateFileNameWithExtension(e.name);

                        var n, r = a(e.previewElement.querySelectorAll("[data-dz-name]"), !0);
                        try {
                            for (r.s(); !(n = r.n()).done;) {
                                var i = n.value;
                                i.textContent = newFileName; // Set the new file name
                            }
                        } catch (e) {
                            r.e(e);
                        } finally {
                        ...
                        if (this.options.addRemoveLinks) {
                            e._removeLink = b.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>");
